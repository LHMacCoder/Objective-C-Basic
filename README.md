...
* [Objective-C对象的分类](#Objective-C对象的分类)
  * [实例对象(instance对象)](#实例对象(instance对象))
  * [类对象（Class对象）](#类对象（Class对象）)
  * [元类对象（meta-class对象）](#元类对象（meta-class对象）)
* [isa指针和superclass指针](#isa指针和superclass指针)
  * [isa指针](#isa指针)
  * [superclass指针](#superclass指针)
  * [isa和superclass总结](#isa和superclass总结)
* [类的结构](#类的结构)
  * [isa指针结构](#isa指针结构)
  * [类对象和元类对象的本质](#类对象和元类对象的本质)
    * [struct objc_class](#struct_objc_class)
* [KVO & KVC](#KVO_&_KVC)
  * [KVO](#KVO)
    * [未使用KVO监听的对象](#未使用KVO监听的对象)
...
* [Category](#Category)
  ...
  * [分类的加载过程](#分类的加载过程)
    ...
    * [+initialize和+load方法对比](#+initialize和+load方法对比)
* [关联对象](#关联对象)
  * [objc_AssociationPolicy](#objc_AssociationPolicy)
  * [关联对象的原理](#关联对象的原理)
* [block](#block)
  * [block本质](#block本质)
  * [block的声明](#block的声明)
  * [block变量的捕获](#block变量的捕获)
  * [block的类型](#block的类型)
  * [block的copy](#block的copy)
  * [访问对象类型的auto变量](#访问对象类型的auto变量)
  * [\__block修饰符](#\__block修饰符)
  * [\__block内存管理](#\__block内存管理)
  * [被\__block修饰的对象类型](#被\__block修饰的对象类型)
  * [循环引用问题](#循环引用问题)
    * [ARC下解决循环引用问题](#ARC下解决循环引用问题)
    * [MRC下解决循环引用问题](#MRC下解决循环引用问题)
